      ...
      <header>
         ...
         <nav>
            <ul class="main-nav container">
               ...
               <li class="nav-item"><a class="link-nav" href="#">Get ZP<i class="icon-drop  fas fa-caret-down"></i></a>
                  <ul class="menu-dropdown">
                     <li class="item-dropdown"><a class="dropdown-link" href="#">Add ZP | 0 ZP</a></li>
                     <li class="item-dropdown"><a class="dropdown-link" href="#">Get Free ZP</a></li>
                  </ul>
               </li>
               <li class="nav-item"><a class="link-nav" href="#">Hello >>Nama<<<i class="icon-drop  fas fa-caret-down">
                        </i></a>
                  <ul class="menu-dropdown">
                     <li class="item-dropdown"><a class="dropdown-link" href="#">My Account</a></li>
                     ...
                     <li class="item-dropdown"><a class="dropdown-link" href="#">Log Out</a></li>
                  </ul>
               </li>
            </ul>
         </nav>
